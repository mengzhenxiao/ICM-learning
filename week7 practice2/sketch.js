...
function setup() {
  ...
  loadJSON('https://api.openweathermap.org/data/2.5/forecast/daily?q=Shanghai&mode=json&units=metric&cnt=7&APPID=001b0f58045147663b1ea518d34d88b4', gotData1);
  loadJSON('https://api.openweathermap.org/data/2.5/forecast/daily?q=Newyork&mode=json&units=metric&cnt=7&APPID=001b0f58045147663b1ea518d34d88b4', gotData2);
  rectMode(CENTER);
  textAlign(CENTER);
}
